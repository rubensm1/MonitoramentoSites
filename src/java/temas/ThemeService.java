...
public class ThemeService {
    ...
    public Object getTemaAtual() {
        return temaAtual.getName();
    }

    public void setTemaAtual(Object nomeTema) {
        for (Theme theme : themes) {
            if (theme.getName().equals(nomeTema))
                this.temaAtual = theme;
        }
    }
    public void sauvaTema(Object object) {
