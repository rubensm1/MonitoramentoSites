...
TabelaStatusConexao = (function() {
    ...
    TabelaStatusConexao.prototype.obtemIDs = function() {
        var listaIDs = [];
        $("form#formConteudo table tr td:nth-child(2)").each(
                function(index) {
    ...
    TabelaStatusConexao.prototype.removeClasseEstiloLinha = function(id, force) {
        if (this.listaLinhasConexoes[id] !== undefined) {
            if (force) {
                if (this.listaLinhasConexoes[id].tr.hasClass("ui-datatable-even"))
                    this.listaLinhasConexoes[id].tr.attr("class", "ui-widget-content ui-datatable-even");
                else if (this.listaLinhasConexoes[id].tr.hasClass("ui-datatable-odd"))
                    this.listaLinhasConexoes[id].tr.attr("class", "ui-widget-content ui-datatable-odd");
            }
            else {
    ...
    TabelaStatusConexao.prototype.sort = function(idLinha) {
        ...
        function reconstroiLinhas(listaOrd) {
            var corpoTabela = $("form#formConteudo table tbody")[0];
